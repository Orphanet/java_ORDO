...
public class ManchesterOWLSyntaxParserImpl implements
    ...
    public List<OntologyAxiomPair> parseRuleFrame() {
        ...
        SWRLRule rule = dataFactory.getSWRLRule(new LinkedHashSet<SWRLAtom>(body),
            new LinkedHashSet<SWRLAtom>(head));
    ...
    private SWRLAtom parseRuleAtom() {
        ...
        if (isClassName(predicate)) {
            ...
            consumeToken();
            List<String> kw = new ArrayList<String>(ruleBuiltIns.keySet());
